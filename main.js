...
//   <span class="id" id="id">${data[i].id}</span>
//   <span>|</span>
//   <span class="count" id="count">${data[i].rating.count}</span>
// </div>
// <span class="left"><img src="${data[i].image}" alt="" id="img"></span>
// <div class="mid">
//   <span class="product_title" id="title">${data[i].title.slice(0,25)} ...
//       <span id="price">${data[i].price}</span>
//   </span>
//   <span class="product_description" id="descrip">${data[i].description.slice(
//     0,200
//   )} ...</span>
//   <span class="product_category" id="category">${data[i].category}</span>
// </div>
// <div class="right">
// <span class="rating">${data[i].rating.rate}</span>
